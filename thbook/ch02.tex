\eject
\vbox{\pic[93.2mm]{agrippa.jpg}
\kern-3.48cm
\eightit\baselineskip16.3pt\leftskip2mm\rightskip6.8cm\parindent4.05cm
...
\hbox to 91.2mm{\hfil\eightrm ---Henricus C. Agrippa ab Nettesheym, \eightmit 1533}
}
...
* |JTSK|, |iJTSK| = Czechoslovak S-JTSK system with south and west
...
Therion contains built-in IGRF\[See \www{http://www.ngdc.noaa.gov/IAGA/vmod/}] 
Earth geomagnetic field model valid for period 
1900--2015\NEW{5.3}. It is automatically used if the cave is located in space using 
...
\comopt
  ...
  * |grade <grade list>| = sets standard deviations according to the
    ...
    Currently supported values are BCRA3 and BCRA5.
